...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<title>EGS Meters Online System</title>
		...
		<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/default/img/favicon.ico" />
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/default/js/bootstrap-datepicker.js"></script>
			...
			<div class="navbar-inner">
				...
				<div class="container">
					...
					<ul class="nav">
						...
						<li><a href="" class="logo"><h2><font color="white">JTU Metering Portal</font></h2></a></li>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('meters'); ?><b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><?php echo anchor('client_meters/form', lang('add_meter')); ?></li>
								<li><?php echo anchor('client_meters/index', lang('view_meters')); ?></li>
							</ul>
						</li>


						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('users'); ?><b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><?php echo anchor('users/form', lang('add_user')); ?></li>
								<li><?php echo anchor('users/index', lang('view_users')); ?></li> 
							</ul>
						</li>
					...
					<ul class="nav pull-right settings">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><?php echo anchor('council/index', lang('council_form')); ?></li>
								<!--<li><?php echo anchor('tariff_type/index', lang('tariff_type')); ?></li>-->

								<li><?php echo anchor('tariff_type_city_power/index', lang('add_city_power_tariff_type')); ?></li>
								<li><?php echo anchor('tariff_type_ekuhurleni/index', lang('add_ekuhurleni_tariff_type')); ?></li>
								<li><?php echo anchor('tariff_type_tshwane/index', lang('add_tshwane_tariff_type')); ?></li>

								<li><?php echo anchor('consumption_time/index', lang('add_consumption_time')); ?></li>
								<li><?php echo anchor('holidays/index', lang('add_holidays')); ?></li>

								<li><?php echo anchor('seasons/index', lang('seasons')); ?></li>
