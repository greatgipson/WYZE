<div class="tab-info">
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[pdf_quote_template]" class="form-control">
				<option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[public_quote_template]" class="form-control">
				<option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[email_quote_template]" class="form-control">
                <option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="settings[quotes_expire_after]" class="input-small form-control" value="<?php echo $this->mdl_settings->setting('quotes_expire_after'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[default_quote_group]" class="form-control">
				<option value=""></option>
