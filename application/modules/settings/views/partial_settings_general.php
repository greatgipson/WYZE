...
<div class="tab-info">
	...
	<div class="control-group">
		...
		<div class="controls" style="text: bottom;">
			<input type="text" class="input-small form-control" value="<?php echo $current_version; ?>" readonly="readonly">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls" style="text: bottom;">
			<input type="text" name="settings[currency_symbol]" class="input-small form-control" value="<?php echo $this->mdl_settings->setting('currency_symbol'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls" style="text: bottom;">
			<input type="text" name="settings[thousands_separator]" class="input-small form-control" value="<?php echo $this->mdl_settings->setting('thousands_separator'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls" style="text: bottom;">
			<input type="text" name="settings[decimal_point]" class="input-small form-control" value="<?php echo $this->mdl_settings->setting('decimal_point'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select class="input-small form-control" name="settings[tax_rate_decimal_places]" id="tax_rate_decimal_places">
	...
	<div class="control-group">
		...
		<div class="controls" style="text: bottom;">
			<input type="text" name="settings[cron_key]" id="cron_key" class="input form-control" value="<?php echo $this->mdl_settings->setting('cron_key'); ?>">
            <input type="button" class="btn btn-primary" id="btn_generate_cron_key" value="<?php echo lang('generate'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
            ...
            <?php } ?>
			<input type="file" name="login_logo" class="form-control" size="40" />
		</div>
	</div>
