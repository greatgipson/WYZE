<div class="tab-info">
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[pdf_invoice_template]" class="form-control">
				<option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[pdf_invoice_template_paid]" class="form-control">
				<option value=""></option>
				<?php foreach ($pdf_invoice_templates as $invoice_template) { ?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[public_invoice_template]" class="form-control">
				<option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[email_invoice_template]" class="form-control">
                <option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[email_invoice_template_paid]" class="form-control">
                <option value=""></option>
                <?php foreach ($email_templates as $email_template) { ?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="settings[invoices_due_after]" class="input-small form-control" value="<?php echo $this->mdl_settings->setting('invoices_due_after'); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[default_invoice_group]" class="form-control">
				<option value=""></option>
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea name="settings[default_invoice_terms]" class="form-control" style="width: 400px; height: 150px;"><?php echo $this->mdl_settings->setting('default_invoice_terms'); ?></textarea>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
            ...
            <?php } ?>
			<input type="file" name="invoice_logo" class="form-control" size="40" />
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[automatic_email_on_recur]" class="form-control">
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="settings[mark_invoices_sent_pdf]" class="form-control">
