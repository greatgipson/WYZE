						...
						<tbody>
							...
							<tr>
								...
								<td width="401px">
									...
									<a href="<?php echo site_url('guest/invoices/edit/' . $invoice->invoice_id); ?>" class="btn btn-secondary btn-sm">
										<i class="fa fa-edit"></i> <?php echo lang('edit'); ?>
									</a>
									<a href="<?php echo site_url('guest/council_invoices/compareview/' . $invoice->invoice_id); ?>" class="btn btn-secondary btn-sm">
										<i class="fa fa-random"></i> Compare with EGSMeter
									</a>
									<!--
