    ...
    <div class="row-fluid">
		<div class="widget">
			...
			<div class="widget-title">
				...
				<h5><?php echo lang('phasor_graph'); ?></h5>
					  ...
					  <tr>
						...
						<td>
						 	<select name="pid" onchange="document.getElementById('selectionchanged').value = '1'; document.forms['client_meter'].submit();">
							  ...
							  <?php
							  	//2015-10-06
								$QueryResults = "select profileid,datentime from fi_meter_status where DATE_FORMAT(datentime,'%Y-%m-%d')='".$dateinstallation."' and meternum=".$this->session->userdata('meter_number')." order by datentime asc";
