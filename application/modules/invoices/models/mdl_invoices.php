...
class Mdl_Invoices extends Response_Model {
    ...
    public function default_select()
    {
        $this->db->select("
			...
			fi_users.user_email,
			fi_users.user_web,
        	fi_users.user_it_codfisc,
			fi_users.user_it_piva,
			fi_clients.*,
			fi_meters.*,
			fi_tariff.*,
			fi_council.*,
			...
			fi_invoices.*", FALSE);
			 ...
			 //  $this->db->where('fi_invoices.invoice_type_id', 1);
        //---it---: aggiunta campi fi_users.user_it_codfisc e fi_users.user_it_piva in query
    }
    ...
    public function default_join()
    {
        ...
        $this->db->join('fi_meters', 'fi_meters.id = fi_invoices.meter_id');
        $this->db->join('fi_tariff', 'fi_tariff.tariff_id = fi_invoices.tariff_id');
        $this->db->join('fi_council', 'fi_council.id = fi_invoices.council_id');
