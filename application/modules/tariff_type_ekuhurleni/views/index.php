<div class="headerbar">
	<div class="breadcrumb">
		<div class="row">
		<div class="col-sm-6">
			<h4><?php echo lang('tariff_type_ekuhurleni_form'); ?></h4>
		</div>
		<div class="col-sm-6">
			<div class="pull-right">
				<a class="btn btn-primary" href="<?php echo site_url('tariff_type_ekuhurleni/form'); ?>"><i class="fa fa-user-circle"></i><?php echo lang('new'); ?></a>
			</div>
			<div class="pull-right">
				<?php echo pager(site_url('tariff_type_ekuhurleni/index'), 'mdl_tariff_type_ekuhurleni'); ?>
			</div>
		</div>
	</div>
	</div>
...
<div class="table-content">
	...
	<table class="table table-striped">
		...
		<tbody>
			<?php foreach ($tariff_type_ekuhurleni as $tariff_type) { ?>
			<tr>
					...
					<div class="options btn-group">
						...
						<ul class="dropdown-menu">
							<li class="dropdown-item">
								<a href="<?php echo site_url('tariff_type_ekuhurleni/form/' . $tariff_type->tariff_id); ?>">
									<i class="icon-pencil"></i> <?php echo lang('edit'); ?>
								</a>
							</li>
							<li class="dropdown-item">
								<a href="<?php echo site_url('tariff_type_ekuhurleni/delete/' . $tariff_type->tariff_id); ?>" onclick="return confirm('<?php echo lang('delete_record_warning'); ?>');">
