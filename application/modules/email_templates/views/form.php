<form method="post" class="form-horizontal">
	...
	<div class="headerbar">
		<div class="breadcrumb">
			<div class="col-sm-6">
				<h4><?php echo lang('email_template_form'); ?></h4>
			</div>
			<div class="col-sm-6">
	...
	<div class="container-fluid">
		...
		<?php $this->layout->load_view('layout/alerts'); ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="email_template_title" id="email_template_title" class="form-control" value="<?php echo $this->mdl_email_templates->form_value('email_template_title'); ?>" class="span8">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="email_template_body" id="email_template_body" class="form-control" style="height: 200px;" class="span8"><?php echo $this->mdl_email_templates->form_value('email_template_body'); ?></textarea>
				</div>
			</div>
