...
class Mdl_Setup extends CI_Model {
    ...
    {
		//---it---inizio
		$this->db->insert('fi_invoice_groups', array('invoice_group_name'	 => 'Fattura predefinita', 'invoice_group_next_id'	 => 1));
		$this->db->insert('fi_invoice_groups', array('invoice_group_name'	 => 'Preventivo predefinito', 'invoice_group_prefix'	 => 'PRE', 'invoice_group_next_id'	 => 1));
		//---it---fine
	}
