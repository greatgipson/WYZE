            ...
            <div id="invoice-items">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="no-bottom-border" colspan="3"></td>
                            <td style="align=right;"><?php echo lang('total'); ?>:</td>
                            <td><?php echo format_currency($invoice->invoice_total); ?></td>
                        </tr>
                        <tr>
                            <td class="no-bottom-border" colspan="3"></td>
                            <td style="align=right;"><?php echo lang('paid'); ?></td>
                            <td><?php echo format_currency($invoice->invoice_paid) ?></td>
                        </tr>
                        <tr>
                            <td class="no-bottom-border" colspan="3"></td>
                            <td style="align=right;"><?php echo lang('balance'); ?></td>
