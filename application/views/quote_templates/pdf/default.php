                ...
                <tr>
                    <td id="company-name">
                        ...
                        <p>
                            ...
                            <?php if ($quote->user_phone) { ?>Tel. <?php echo $quote->user_phone; ?><br><?php } ?>
                            <?php if ($quote->user_fax) { ?>Fax <?php echo $quote->user_fax; ?><?php } ?>
                            <?php //---it---inizio ?>
                ...
                <tr>
                    <td style="padding-left: 5px;">
                        ...
                        <p><?php echo $quote->client_name; ?><br>
                            ...
                            <?php if ($quote->client_phone) { ?>Tel. <?php echo $quote->client_phone; ?><br><?php } ?>
                            <?php //---it---inizio ?>
